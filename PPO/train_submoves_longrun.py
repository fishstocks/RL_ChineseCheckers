...
def parse_args():
    parser = argparse.ArgumentParser(description="Long-running resumable PPO trainer for 2-player submoves.")
    parser.add_argument("--run-name", default=os.environ.get("APO_RUN_NAME", "ppo_submoves_6h"))
    parser.add_argument("--hours", type=float, default=float(os.environ.get("APO_TRAIN_HOURS", "6")))
    ...
    parser.add_argument("--total-timesteps", type=int, default=int(os.environ.get("APO_TOTAL_TIMESTEPS", "50000000")))
...
def main():
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        name_prefix="checkers_ppo_submoves",
        verbose=1,
    )
